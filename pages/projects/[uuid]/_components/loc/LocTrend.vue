<template>
	<div class="space-y-2">
		<div class="flex justify-en items-center gap-x-2">
			...
			<DropdownButton :icon="CalendarIcon" :label="$t(selectedDuration)" class="ml-auto">
				<DropdownItem v-for="duration of Object.values(TDuration)" :value="duration"
...
import { TDuration, TFileType, type ILocScanChartData, type ILocScanFile } from "../../_types";
